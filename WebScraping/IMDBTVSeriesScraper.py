...
# Define the function to scrape top TV series from IMDb
def scrape_imdb_top_tv_series():
    ...
    # Make a GET request to IMDb's top TV series page with the defined headers
    ...
    # Find all containers that hold the TV series information on the page
    tvseries_containers = soup.find_all('div', class_='sc-be6f1408-0 gVGktK cli-children')

    # Initialize lists to store TV series data
    titles = []
    release_years = []
    runtimes = []
    rateds = []

    # Loop through each TV series container to extract information
    for container in tvseries_containers:
